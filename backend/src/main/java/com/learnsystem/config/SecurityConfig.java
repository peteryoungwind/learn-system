...
import com.learnsystem.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private void writeUnauthorized(HttpServletResponse response) throws IOException {
        ...
        response.getWriter().write(objectMapper.writeValueAsString(ApiResponse.failure("请先登录")));
    }

    private void writeForbidden(HttpServletResponse response) throws IOException {
        response.setStatus(HttpServletResponse.SC_FORBIDDEN);
        response.setContentType(MediaType.APPLICATION_JSON_VALUE);
        response.getWriter().write(objectMapper.writeValueAsString(ApiResponse.failure("无访问权限")));
    }
}
